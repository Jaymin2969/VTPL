...
function login(payload) {
    return axios.post('https://identity-service-test.dezensolutions.com/login', payload);
}
...
function register(payload) {
    return axios.post('https://identity-service-test.dezensolutions.com/register', payload);
}
